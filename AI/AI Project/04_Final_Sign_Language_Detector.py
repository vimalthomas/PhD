...
# MAGIC %md
# MAGIC This notebook accepts image path as the parameter

# COMMAND ----------

#The notebook accepts image path as the parameter. 
dbutils.widgets.text("image_path", "path/to/image", "Image Path")
image_path = dbutils.widgets.get("image_path")

# COMMAND ----------

# Load the image DataFrame from Parquet file
df_images = spark.read.format('image').load(image_path)
